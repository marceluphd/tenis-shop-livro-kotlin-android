...
import thiengo.com.br.tenisshop.util.setGenre
import thiengo.com.br.tenisshop.util.setImageViewBgColor
import thiengo.com.br.tenisshop.util.setStar
...
class SneakerDetailsActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setStar(window.decorView, R.id.iv_rating_star_01, 1, sneaker.rating.stars)
        setStar(window.decorView, R.id.iv_rating_star_02, 2, sneaker.rating.stars)
        setStar(window.decorView, R.id.iv_rating_star_03, 3, sneaker.rating.stars)
        setStar(window.decorView, R.id.iv_rating_star_04, 4, sneaker.rating.stars)
        setStar(window.decorView, R.id.iv_rating_star_05, 5, sneaker.rating.stars)
    }
